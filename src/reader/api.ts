...
import { loadProgress, saveProgress, loadBookmarks, saveBookmarks } from './state';
 ...
 */
export function saveReadingProgress(bookUuid: string, page: number): Promise<void> {
	return new Promise(function(resolve, reject) {
		try {
			// 调用状态管理器的保存方法
			saveProgress();
 ...
 */
export function getReadingProgress(bookUuid: string): Promise<ReadingProgress | null> {
	return new Promise(function(resolve, reject) {
		try {
			// 调用状态管理器的加载方法
 ...
 * @returns Promise<void>
 */
export function saveBookmark(bookUuid: string, page: number): Promise<void> {
	return new Promise(function(resolve, reject) {
		try {
			// 调用状态管理器的保存方法
			saveBookmarks();
 ...
 * @returns Promise<void>
 */
export function removeBookmark(bookUuid: string, page: number): Promise<void> {
	return new Promise(function(resolve, reject) {
		try {
			// 调用状态管理器的保存方法
			saveBookmarks();
